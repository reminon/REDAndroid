package com.greatposterwall.data.model;
...
public class Collage {
    ...
    public static class Response {
        ...
        public static class TorrentGroup {
            ...
            com.greatposterwall.data.model.TorrentGroup.MusicInfo musicInfo;

            // https://stackoverflow.com/a/3236616
            private static String concatArtistsWithCommas(List<com.greatposterwall.data.model.TorrentGroup.Artists> artists) {
                StringBuilder wordList = new StringBuilder();
                for (com.greatposterwall.data.model.TorrentGroup.Artists artist : artists) {
