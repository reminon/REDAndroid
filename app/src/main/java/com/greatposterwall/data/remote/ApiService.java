package com.greatposterwall.data.remote;
...
import com.greatposterwall.app.BuildConfig;
...
import com.greatposterwall.data.remote.interceptors.AddApiKeyInterceptor;
import com.greatposterwall.data.remote.interceptors.AddCookiesInterceptor;
import com.greatposterwall.data.remote.interceptors.ReceivedCookiesInterceptor;
...
public interface ApiService {
    ...
    String ENDPOINT = GPWApplication.DEFAULT_SITE + "/";
    ...
    Single<com.greatposterwall.data.model.Request> request(@Query("id") int id);
