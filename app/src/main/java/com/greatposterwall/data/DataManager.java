package com.greatposterwall.data;
...
import com.greatposterwall.data.remote.PyWhatAutoService;
...
public class DataManager {
    ...
    public Single<Response<ResponseBody>> downloadPywaRelease(final int id) {
        ...
        return pywa.addTorrent(mPreferencesHelper.getPywaPassword(), "greatposterwall", id);
    }
